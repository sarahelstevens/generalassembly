...
//VS Refactored: (yes we can do without the quotation marks but since we haven't done objects we don't want to be explaining why we don't need quotation marks)
