...
var q1 = [1,2,3,4];
q1.forEach(function(element,index){		//.forEach is a function that allows you to manipulate index and elements
	q1[index] = element + 1; 			//q1[index] allows you to access the elements of the array
});
